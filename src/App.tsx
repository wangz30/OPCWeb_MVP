...
import { AiCloudResourcesPage } from './pages/AiCloudResources'
    ...
    <>
      ...
      <main>
        <Routes>
          ...
          <Route path="/ai-cloud-resources" element={<div className="container mx-auto px-4 py-8"><AiCloudResourcesPage /></div>} />
