...
export function CloudResourcesPage() {
  ...
  const cloudResources = [
    {
      category: '云计算',
      name: '弹性云服务器 ECS',
      description: '灵活可调配的云端计算资源，支持弹性伸缩，助力业务快速上线。提供 2 核 4G、4 核 16G 等多种配置，按需付费，经济实惠',
      icon: Server,
      specs: ['2 核 | 4G', '4 核 | 16G', '弹性伸缩', '按需付费'],
      price: '按需选择',
      color: '#6C63FF'
    },
    {
  ...
  return (
    <div style={{ 
      ...
      <div style={{
        position: 'relative',
        background: `url("${import.meta.env.BASE_URL}Pic4CloudResource/1.png") center/cover no-repeat`,
