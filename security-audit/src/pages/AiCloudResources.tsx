...
export function AiCloudResourcesPage() {
  ...
  const aiModels = [
    ...
    {
      name: '文心一言',
      description: '百度推出的生成式 AI 产品，支持文学创作、商业文案',
      category: 'LLM',
      tags: ['免费', 'API'],
      color: '#10B981'
    },
    {
      name: '智谱清言',
      description: '基于 ChatGLM 的中英双语对话模型，支持智能问答',
      category: 'LLM',
      tags: ['免费', 'API'],
      color: '#F59E0B'
    },
    ...
    {
      name: 'Midjourney',
      description: 'AI 图像生成工具，生成高质量艺术作品',
      category: '图像生成',
      tags: ['付费', 'API'],
      color: '#8B5CF6'
    },
    {
      name: 'Whisper',
      description: 'OpenAI 语音识别模型，支持多语言转文字',
      category: '语音识别',
      tags: ['开源', '免费'],
      color: '#14B8A6'
    },
    {
      name: 'ElevenLabs',
      description: 'AI 语音合成，支持 28 种语言 natural 语音',
      category: '语音合成',
      tags: ['付费', 'API'],
      color: '#F97316'
    }
  ...
  const cloudResources = [
    {
      name: 'GPU 云服务器',
      description: '配备 NVIDIA V100/A100 GPU，支持深度学习训练',
      icon: Server,
      specs: ['8 核 32G', 'NVIDIA V100', '100G SSD'],
      price: '¥299/月起',
      color: '#6C63FF'
    },
    {
      name: 'AI 推理服务器',
      description: '低延迟 GPU 推理实例，适合生产环境部署',
      icon: Zap,
      specs: ['4 核 16G', 'T4 GPU', '50G SSD'],
      price: '¥199/月起',
      color: '#3B82F6'
    },
    {
      name: '对象存储 COS',
      description: '海量非结构化数据存储，支持 CDN 加速',
      icon: Cloud,
    ...
    {
      name: '云数据库',
      description: 'MySQL/PostgreSQL/MongoDB 等多种数据库',
      icon: Database,
  ...
  const dataAPIs = [
    ...
    {
      name: '地图位置 API',
      description: 'POI 检索、路径规划、地理编码服务',
      category: '位置数据',
      calls: '10,000 次/免费',
      latency: '<50ms',
      color: '#14B8A6'
  ...
  const tabs = [
    ...
    { id: 'data-api', label: '数据 API', icon: Database }
  ]
